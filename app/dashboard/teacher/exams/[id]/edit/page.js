// ============================================================
// app/dashboard/teacher/exams/[id]/edit/page.js
// تعديل الامتحان – النسخة الأسطورية المتكاملة V9 (total_marks تلقائي)
...
// ============================================================
// 4. مكون المعاينة الجانبية (Live Preview) – مع دعم البنك والثيم
// ============================================================
...
// ============================================================
// 5. الصفحة الرئيسية – تعديل الامتحان
// ============================================================
...
export default function EditExamPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // 3. تعيين بيانات النموذج – بدون total_marks (تبقى من examData للعرض فقط)
      setFormData({
  ...
  // ===== التحقق من صحة النموذج – بدون total_marks =====
  const validateForm = () => {
    const errors = {};
    ...
    // لا نتحقق من passing_marks > total_marks لأن الأخيرة تدار تلقائياً
  ...
  // ===== تحديث الامتحان – لا نرسل total_marks =====
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // إعادة جلب البيانات لتحديث العرض (خاصة total_marks)
      fetchData();
      setTimeout(() => {
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-4 border-t border-white/5">
                    ...
                    <div className={`mt-2 p-3 rounded-xl ${isDark ? 'bg-white/5' : 'bg-gray-100'} text-xs ${isDark ? 'text-gray-400' : 'text-gray-600'} space-y-1`}>
                      ...
                      <p><span className="font-semibold text-yellow-400">📊 التحليل:</span> سيتم تحليل سلوك الطالب أثناء الامتحان (مثل النظر بعيداً، أصوات الخلفية).</p>
                    </div>
                  </div>

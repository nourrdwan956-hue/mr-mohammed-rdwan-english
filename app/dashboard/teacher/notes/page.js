...
// ================================================================
// 📝 المسار: app/dashboard/teacher/notes/page.js
// صفحة الملاحظات المتكاملة – قائمة، إضافة، تعديل، حذف
// ================================================================
// الميزات:
// - عرض جميع ملاحظات المعلم عن طلابه (خاصة بالمعلم فقط).
...
// ----- useTheme محلي -----
const useTheme = () => {
  const [theme, setTheme] = useState(() => { try { return localStorage.getItem('teacherNotesTheme') || 'dark'; } catch { return 'dark'; } });
  useEffect(() => { localStorage.setItem('teacherNotesTheme', theme); document.documentElement.className = theme; }, [theme]);

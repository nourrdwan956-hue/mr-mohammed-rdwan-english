          ...
          <div className="flex items-center md:items-start gap-4 md:gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                <h3 className={`text-lg font-bold ${styles.text} group-hover:text-yellow-300 transition-colors cursor-pointer`} onClick={() => onViewProfile(student.id)}>
                  {student.name}
                </h3>
    ...
    return (
      <AssistantLayout>
        <div className={`text-center py-20 ${styles.bg}`}>
          <Icons.Lock className={`h-16 w-16 ${styles.subtext} mx-auto mb-4`} />
          <p className={`text-lg font-bold ${styles.text}`}>غير مصرح لك</p>
          <p className={`${styles.subtext} mt-2`}>ليس لديك صلاحية عرض الطلاب</p>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3 mt-3 md:mt-0">
              <button
                ...
                className={`px-4 py-2 ${styles.card} border ${styles.border} rounded-xl text-sm hover:border-yellow-400/50 transition flex items-center gap-2 ${styles.text}`}
              >
            ...
            <div className={`text-center py-20 ${styles.card} border ${styles.border} rounded-3xl`}>
              ...
              <p className={`${styles.subtext} text-sm mt-2`}>
                {searchQuery || filterStatus !== 'all' || filterCourse !== 'all'
                  ...
                  : 'سيظهر الطلاب هنا عند تسجيلهم في كورسات المعلم'}
              </p>
            </div>
          ) : (

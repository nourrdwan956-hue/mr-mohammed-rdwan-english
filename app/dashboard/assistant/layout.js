...
// ================================================================
// 🧩 AssistantLayout – التخطيط الموحد للمساعد (متوافق مع TeacherLayout)
// ================================================================
// - يستخدم نفس useTheme مع مفتاح تخزين موحد 'platformTheme'
// - يطبق الأنماط بنفس طريقة TeacherLayout
// - شريط جانبي ديناميكي حسب الصلاحيات
// ================================================================
...
const Sidebar = ({ isOpen, onClose, assistant, permissions, styles, pathname }) => {
  ...
  return (
    <>
      ...
      >
        {/* رأس الشريط الجانبي – مع الشعار الجديد بجوار "منصة محمد رضوان" */}
        ...
        {/* معلومات المساعد – تعرض الحرف الأول من اسمه (وليس الشعار) */}
        {assistant && !isCollapsed && (
          <div className={`p-4 border-b ${styles.border}`}>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-400/30 to-yellow-600/30 flex items-center justify-center text-yellow-400 font-bold text-lg flex-shrink-0">

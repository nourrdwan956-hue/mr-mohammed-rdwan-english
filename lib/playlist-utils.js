 ...
 * تم تبسيط الدالة لتتجاهل جدول assistants لتجنب أخطاء الأعمدة غير الموجودة
 * @param {string} userId
...
export async function verifyCourseOwnership(userId, courseId) {
  try {
    ...
    // التحقق من أن المستخدم هو صاحب الكورس (المعلم)
    ...
    // إذا لم يكن المعلم، نعيد false (يمكن إضافة منطق المساعدين لاحقاً عند الحاجة)

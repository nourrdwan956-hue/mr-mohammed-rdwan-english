...
// إنشاء عميل Resend باستخدام المفتاح من البيئة
export const resend = new Resend(process.env.RESEND_API_KEY);

// عنوان المرسل – هنستخدم النطاق الافتراضي لـ Resend حالياً
// ولو حابب تضيف نطاقك الخاص بعدين، تقدر تغيره
export const FROM_EMAIL = 'onboarding@resend.dev'; // النطاق الافتراضي لـ Resend
    ...
    <div dir="rtl" style="font-family: 'Cairo', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 30px; border-radius: 16px; border: 1px solid #e5e7eb;">
      ...
      <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${resetLink}" style="display: inline-block; padding: 14px 32px; background: #FACC15; color: #000; text-decoration: none; border-radius: 10px; font-weight: bold; font-size: 16px; transition: background 0.2s;">إعادة تعيين كلمة المرور</a>
        </div>

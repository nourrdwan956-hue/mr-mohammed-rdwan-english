...
export default function WaveBorderCard({ children, className = '', initialColor = 'blue', onColorChange }) {
  ...
  useEffect(() => {
    ...
    //    rAF بيتوقف تلقائياً عندما يكون العنصر غير مرئي أو التبويب inactive
    const animate = () => {
